...
<p align="center">
<strong>全能型网盘助手：支持115、123云盘自动分类整理，STRM文件创建及302跳转，支持 Telegram 频道监控、多网盘（123/115/天翼/夸克）自动转存、全网视频下载（B站/抖音）、WebSSH终端、以及各类资源的秒传与直链播放。</strong>
</p>
...
* **配置内容**:
  ...
  * 配置增量监控的分享链接。
  * 新增功能配置：WebSSH、Emby海报刷新、STRM同步等设置。
